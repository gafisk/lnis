...
$information = query("SELECT user.nama,informasi.*,jenis.barang FROM user INNER JOIN informasi ON user.username = informasi.pengirim INNER JOIN jenis ON informasi.jenis = jenis.id WHERE informasi.berita = 'Ditemukan'");
?>
<?php
